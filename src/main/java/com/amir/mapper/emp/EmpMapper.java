...
public interface EmpMapper {
    ...
    List<com.amir.vo.EmpSubsidyVo> phoneSubsidyList(@Param("name") String name, @Param("deptId") Integer deptId);

    List<com.amir.vo.EmpSubsidyVo> socialSubsidyList(@Param("name") String name, @Param("deptId") Integer deptId);

    List<EmpSubsidyVo> getByNameAndDeptNameList(@Param("empName") String empName, @Param("deptName") String deptName, @Param("type") Integer type);

...
INSERT INTO `product`.`t_Dictionary` (`type`, `value`)
VALUES ('1', '泡棉类');
INSERT INTO `product`.`t_Dictionary` (`type`, `value`)
VALUES ('1', '主要面料类');
INSERT INTO `product`.`t_Dictionary` (`type`, `value`)
...
INSERT INTO `product`.`t_SysDept` (`deptName`, `deptOrder`, `isWorkShop`)
VALUES ('经理室', NULL, 0);
INSERT INTO `product`.`t_SysDept` (`deptName`, `deptOrder`, `isWorkShop`)
VALUES ('人事部', NULL, 0);
INSERT INTO `product`.`t_SysDept` (`deptName`, `deptOrder`, `isWorkShop`)
...
INSERT INTO `product`.`t_SysUser` (`deptId`, `roleId`, `loginName`, `loginPwd`, `userName`)
...
INSERT INTO `product`.`t_SysRole` (`name`, `description`, `roleOrder`)
VALUES ('管理员权限', NULL, '1');
...
INSERT INTO `product`.`t_PM` (`pmNo`, `name`, `type`, `num`, `unit`, `remark`, `operator`, `createTime`,
...
INSERT INTO `product`.`t_PMIn` (`pmId`, `pmNo`, `pmName`, `type`, `unit`, `remark`, `supplier`, `inDate`, `num`,
